...
You operate it simply by opening the Zenbot Control Panel in your browser (localhost:8888) and typing into the chat window. The control panel displays the browser via noVNC and shows live logs from both the browser automation service and the LLM. Zenbot will perform its duties and return nicely-formatted results in the chat window.
...
- **Browser profiles** persist across sessions at `/tmp/zenbot_profiles/`
