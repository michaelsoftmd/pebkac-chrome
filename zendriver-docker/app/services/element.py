...
class ElementService:
    ...
    async def get_element_text(self, selector: Optional[str] = None, 
        ...
        try:
            ...
            # Get text - zendriver elements have a synchronous .text property
            ...
            if "Element not found" in str(e):
                raise ElementNotFoundError(f"Element not found: {selector or text}")
            raise BrowserError(f"Error getting element text: {str(e)}")
    
    async def get_element_attribute(self, selector: Optional[str] = None,
                                   text: Optional[str] = None,
                                   attribute: str = "value") -> Optional[str]:
        ...
        try:
            ...
            if "Element not found" in str(e):
                raise ElementNotFoundError(f"Element not found: {selector or text}")
            raise BrowserError(f"Error getting element attribute: {str(e)}")
    ...
    async def element_exists(self, selector: Optional[str] = None,
        ...
        try:
            ...
            # Any exception means element doesn't exist
            return False
